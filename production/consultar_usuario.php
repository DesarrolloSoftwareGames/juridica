                ...
                <form>
                    <div class="x_panel">
                        ...
                        <div class="modal-footer">
                            <input type="reset" class="btn btn-primary" name="guardar_coordinadores_puesto" value="Guardar" onclick="alert('Usuario Creado Correctamente');">
                            <input type="submit" class="btn btn-primary" name="guardar_coordinadores_puesto" value="Regresar">
                            <a href="cambiar_permisos.php<?php echo '?galletaAUX=' . $galleta; ?>" class="nav-link btn btn-primary">Personalizar Permisos</a>
                        </div>
                    </div>
                </form>
            </div>
                                        ...
                                        <table id="example" class="table table-striped table-bordered" cellspacing="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editar_usuario.php?numeroidenti=masculino&galletaAUX=YWRtaW5AMjAyY2I5NjJhYzU5MDc1Yjk2NGIwNzE1MmQyMzRiNzA=" class="btn btn-secondary"><i class="typcn typcn-pen"></i>
                                                        <a href="eliminar_coordinadores.php?numeroidenti=masculino&galletaAUX=YWRtaW5AMjAyY2I5NjJhYzU5MDc1Yjk2NGIwNzE1MmQyMzRiNzA=" class="btn btn-danger"><i class="typcn typcn-trash"></i>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
