...
<div class="container">
    <div class="row" id="search-box">
        <div class="x_panel">
            <p>
            <p><b class="moda" style="font-size: 24px;">Asociar Imagen a Radicado</b></p>
            <!-- boton primer modal -->
            <div class="x_panel">
                <div class="container">
                    <div class="row px-5">
            ...
            <table id="example" class="table table-striped table-bordered align-items-center" width="100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <button id="add-img-button" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-ingresar-remitente">Asociar Imagen</button>
                            <a href="#" id="img-name" hidden data-toggle="modal" data-target=".bs-example-modal-ver-imagen">imagen.png</a>
                        </td>
                    </tr>
                </tbody>
            </table>
                            ...
                            <div class="x_panelm2 p-3">
                                <div class="container">
                                    <div class="row">
                                        <p>
                                        <div class="col-md-12 col-2 m">
                                            <label for="ingre-img">Seleccione un archivo *</label>
                                            <input id="ingre-img" type="file" name="ingre-img" accept="image/png" class="form-control" aria-describedby="name" placeholder="(mínimo 3 caracteres)" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-2 m">
                                        <label for="ingre-img-desc">Descripción del archivo *</label>
                                        <textarea class="form-control" id="ingre-img-desc" name="ingre-img-desc" rows="6" placeholder="" required></textarea>
                                    </div>
                                    <div class="col-md-12 col-2 m">
                                        <label for="ingre-img-prev">Previsualización *</label>
                                        <img id="ingre-img-prev" src="" class="img-thumbnail" alt="Previsualización" />
                                    </div>
                                    </p>
                                </div>
                            </div>
...
<div class="modal fade bs-example-modal-ver-imagen" tabindex=" -1" role="dialog" aria-hidden="true">
    <form class="row gy-2 gx-3 align-items-center">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 style="font-size:24px;" class="modal-title fa fa-user" id="myModalLabel2">&nbsp;
                        Inspeccionar Imagen de Radicado
                    </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="x_panelm">
                        <p>
                        <p><b class="moda" style="font-size: 24px;">Inspeccionar Imagen de Radicado</b></p>
                        ...
                        <div class="x_panelm2 p-3">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-2 m">
                                        <label for="ingre-img-prev">Previsualización *</label>
                                        <img id="ingre-img-prev" src="../img/barcode.png" class="img-thumbnail" alt="Previsualización" />
                                    </div>
                                    </p>
                                </div>
                            </div>
...
<script>
    ...
    const handleSumbitAdd = (e) => {
        Swal.fire({
            title: 'Imgen Asociada exitosamente',
            text: 'La imagen se ha asociado correctamente',
            icon: 'success',
            confirmButtonText: 'Aceptar'
        });
        document.getElementById('img-name').removeAttribute('hidden');
        document.getElementById('add-img-button').setAttribute('hidden', true);
    };

    document.getElementById('ingre-img').addEventListener('change', (e) => {
        const file = e.target.files[0];
        const reader = new FileReader();
        reader.onloadend = () => {
            document.getElementById('ingre-img-prev').src = reader.result;
        };
