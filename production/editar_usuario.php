                    ...
                    <div class="x_panel">
                        ...
                        <div class="modal-footer">
                            <input type="reset" class="btn btn-primary" name="guardar_coordinadores_puesto"
                                value="Guardar" onclick="alert('Usuario Editado Correctamente');">
                            ...
                            <input type="submit" class="btn btn-primary" data-toggle="modal"
                                data-target=".bs-example-modal-ingresar-elector" value="Personalizar Permisos">
                        </div>
                    </div>
                </form>
            </div>
                                        ...
                                        <table id="example" class="table table-striped table-bordered" cellspacing="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editar_coordinadores.php?numeroidenti=masculino&galletaAUX=YWRtaW5AMjAyY2I5NjJhYzU5MDc1Yjk2NGIwNzE1MmQyMzRiNzA=" class="btn btn-secondary"><i class="typcn typcn-pen"></i>
