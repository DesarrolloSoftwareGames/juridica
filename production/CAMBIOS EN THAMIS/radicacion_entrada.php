...
<div class="x_content">
            <p>
            <h2 style="margin-left: 50px;"><b>Datos Personales</b></h2>
            <div class="x_panel" style="background-color: #e4e3e4;">
              <p class="container" >
              <div class="row">
                <div class="col-md-5 col-sm-10  " style="margin-left: 50px;">
                  <label for="prinombre">Fecha de Ingreso *</label>
                  <input type="date" name="fecha" class="form-control" aria-describedby="emailHelp" placeholder=""
                    required>
                </div>
              
                <div class="col-md-5 col-sm-10  " style="margin-right: 10px;">
                  <label for="prinombre">JARED *</label>
                  <input type="text" name="cargo" class="form-control" value="Coordinador de Puesto"
              ...
              <div class="row">
                <div class="col-md-6 col-sm-10 m">
                  ...
                  <input type="text" name="numeroident" class="form-control" aria-describedby="emailHelp" placeholder=""
                    required>
                </div>
                ...
                <div class="col-md-6 col-sm-10 m">
                  ...
                  <input type="text" name="nombre" class="form-control" aria-describedby="emailHelp" placeholder=""
                    required>
                </div>

                <div class="col-md-6 col-sm-10 m">
                  <label for="prinombre">Apellidos *</label>
                  <input type="text" name="apellidos" class="form-control" aria-describedby="emailHelp" placeholder=""
                    required>
                </div>
                ...
                <div class="col-md-4 col-sm-10 m">
                  ...
                  <input type="text" name="corregimien" class="form-control" aria-describedby="emailHelp"
                    placeholder="">
                </div>
            ...
            <div class="x_panel">
              <p>
              <h4>Lugar de Votación</h4>
              </p>
              <div class="form-group">
                <div class="col-md-4 col-sm-10 m">
                  <label for="prinombre">NUIP*</label>
                  <input type="text" name="nuip" class="form-control" aria-describedby="emailHelp" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-4 col-sm-10 m">
                  <label for="heard">Departamento *</label>
                  <select name="dpto2" id="dpto2" class="form-control" onChange="cargarmunicipio2()" required>
                    <option value="">Seleccione</option>
                    <option value="Amazonas">Amazonas</option>
                    <option value="Antioquia">Antioquia</option>
                    <option value="Arauca">Arauca</option>
              ...
              <div class="form-group">
                <div class="col-md-4 col-sm-10 m">
                  <label for="munici2">Municipio *</label>
                  <select id="munici2" name="munici2" class="form-control">
                    <option value="">seleccione</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-4 col-sm-10 m">
                  <label for="prinombre">Zona *</label>
                  <input type="text" name="zona" class="form-control" aria-describedby="emailHelp" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-4 col-sm-10 m">
                  <label for="prinombre">Puesto *</label>
                  <input type="text" name="puesto" class="form-control" aria-describedby="emailHelp" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-4 col-sm-10 m">
                  <label for="prinombre">Mesa *</label>
                  <input type="text" name="mesa" class="form-control" aria-describedby="emailHelp" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-12 col-sm-10 m">
                  <label for="prinombre">Dirección *</label>
                  <input type="text" name="dir2" class="form-control" aria-describedby="emailHelp" placeholder="">
                </div>
              </div>
            </div>
            </p>
                        ...
                        <div class="x_panelm2">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6  col-10 m">
                                        <label for="heard">Asuntos predeterminado *</label>
                                        <select name="genero" class="form-control" required>
                                            <option value="">Seleccione</option>
                                            <option value="Masculino">Masculino</option>
                                            <option value="Femenino">Femenino</option>
