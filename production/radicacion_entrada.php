            ...
            <div class="x_panel">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12  col-10 my-1 mb-4">
                            <label class="ckbox">
                                <input id="confidencial" name="confidencial" type="checkbox" /><span>¿Usted autoriza recibir respuesta por medio de correo electrónico?</span>
                            </label>
                        </div>
